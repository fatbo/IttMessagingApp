...
Log.d("JPushReceiver","action="+intent.getAction());
		if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {			
			ITTApplication.getInstance().regid = intent.getStringExtra(JPushInterface.EXTRA_REGISTRATION_ID);			
Log.d("JPushReceiver","onReceive regId: "+ITTApplication.getInstance().regid);

			// jpush reg success
			Intent jpushRegSuccessIntent = new Intent("jpush_reg_success");
			context.sendBroadcast(jpushRegSuccessIntent);
